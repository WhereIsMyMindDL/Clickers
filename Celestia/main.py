    ...
    if index_proxy <= count_acc - 1:
        ...
        try:
            ...
            browser.find_element(
                By.XPATH,
                "/html/body/div[1]/div[1]/div/div/main/div[1]/section[4]/div/div[1]/div[2]",
            ).click()
            time.sleep(3)
            browser.find_element(
                By.XPATH,
                "/html/body/div[3]/div/div/div/div/div/div/form/div[2]/div/div[1]/div/input",
            ).click()
            time.sleep(2)
            email_input = browser.find_element(
                By.XPATH, "/html/body/div[3]/div/div/div/div/div/div/form/div[1]/input"
            )
